...
class ChildThreeFragment private constructor() : BaseLazyLoadFragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(param1: String?, param2: String?): ChildThreeFragment {
            val fragment = ChildThreeFragment()
            val args = Bundle()
    ...
    override fun getLayoutRes(): Int = R.layout.fragment_child_three
}