package com.heng.kotlinlimitscrollapplication.javaviews;
...
public class OverScrollLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {

    private final String TAG = "OverScrollLayout";
    ...
    public OverScrollLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OverScrollLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        this.setBackgroundColor(context.getResources().getColor(android.R.color.holo_blue_bright));
    }
...
//                if (Math.abs(scrollY) < 50) {
//                    startY = ev.getY();
//                    isMoved = false;
//                    isRecyclerReuslt = true;
//                    recoverLayout();
//                    Log.d(TAG, "super.dispatchTouchEvent(ev)");
//                    return super.dispatchTouchEvent(ev);
//                }
    ...
    private boolean isCanPullDown() {
        ...
        if (((RecyclerView) childView).getLayoutManager() instanceof LinearLayoutManager) {

            LinearLayoutManager linearLayoutManager = (LinearLayoutManager) ((RecyclerView) childView).getLayoutManager();
            assert linearLayoutManager != null;
            firstVisiblePosition = linearLayoutManager.findFirstVisibleItemPosition();
        } else if (((RecyclerView) childView).getLayoutManager() instanceof GridLayoutManager) {

            GridLayoutManager gridLayoutManager = (GridLayoutManager) ((RecyclerView) childView).getLayoutManager();
